...
Count the signals. You'll reference them in Phase 6 for the closing reflection.
...
One paragraph reflecting on the session. Reference specific things the user said — quote their words back to them. Show what you noticed about how they think.

**Anti-slop rule, show, don't tell:**
- GOOD: "You didn't say 'students,' you said 'Marcus, a 16-year-old who builds keyboards in his bedroom.' That specificity is rare."
- BAD: "You showed great specificity in identifying your target user."

### Next-skill recommendations

Suggest the next step based on what was designed:

- **`/learning-architect`** if the design involves learning content — define desired results and assessment
...
The design doc at `~/.nstack/projects/` is automatically discoverable by downstream skills.
