#!/usr/bin/env bun
/**
 * nstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   nstack-global-discover --since 7d [--format json|summary]
 *   nstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: nstack-global-discover --since <window> [--format json|summary]
...
Examples:
  nstack-global-discover --since 7d
  nstack-global-discover --since 14d --format summary`);
}
