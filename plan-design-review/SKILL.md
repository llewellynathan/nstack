...
10. Cognitive load respects the learner's age. A 14-year-old processes information differently than a 25-year-old. Chunk content, limit choices per screen, and never assume sustained attention beyond 10-15 minutes without an interaction break.
11. Engagement without manipulation. Gamification serves learning, not addiction. Points, streaks, and badges must reinforce mastery, not dopamine loops. If removing the game layer makes the content worthless, the content is the problem.
12. Reading level is a design decision. Write for a 7th-8th grade reading level. Never use "simply," "just," "obviously," or "easy" — these words shame learners who are struggling. Every instruction should be testable: can a 13-year-old follow it without asking an adult?
13. Home safety is a first-class constraint. Every project involves physical tools and materials in an unsupervised home setting. Safety instructions are not supplementary — they are part of the core design, not an afterthought.
...
### Pass 8: Education & Learner Experience (if learning content in scope)
Rate 0-10: Does the plan account for the learner's experience as a self-directed teen?
FIX TO 10: Evaluate against these dimensions:
- **Cognitive load**: How many new concepts per screen? Is there chunking? Interaction breaks?
- **Reading level**: Run key instructional text through a readability check. Target 7th-8th grade.
- **Safety prominence**: Are tool/material safety warnings placed BEFORE the step that uses them, not in a footer?
- **Independence**: Can the learner complete this without asking a parent or teacher for help?
- **Gamification ethics**: Do any engagement mechanics (points, streaks, badges) reinforce learning or just engagement?
**STOP.** AskUserQuestion once per issue. Do NOT batch. Recommend + WHY.
...
```
  ...
  | Pass 8  (Education)  | ___/10 → ___/10 after fixes                |
  +--------------------------------------------------------------------+
